...
#define WIFI_SSID                         "cteqeu"
#define WIFI_PASSWORD                     "VincentV"

/* Security type of the Wi-Fi access point. See 'cy_wcm_security_t' structure
 * in "cy_wcm.h" for more details.
 */
#define WIFI_SECURITY_TYPE                 CY_WCM_SECURITY_WPA2_WPA_AES_PSK
 ...
 * of the PC).
 */
#define UDP_SERVER_IP_ADDRESS             MAKE_IPV4_ADDRESS(192, 168, 223,150)
